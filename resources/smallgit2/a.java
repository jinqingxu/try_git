 /**
    ...
    private JPanel initToolBar() {
        ...
        meepleNumTextArea = new JTextArea(TEXT_FIELD_ROW, TEXT_FIELD_COLUMN);
        JLabel meepleNumLabel = new JLabel("MeepleNumBoard:");
        tools.add(meepleNumLabel);
        tools.add(meepleNumTextArea);
        return tools;
    }
